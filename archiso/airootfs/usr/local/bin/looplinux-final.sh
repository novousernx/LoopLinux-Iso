...
mv /etc/looplinux-release /etc/lsb-release
...
echo "#################################"
echo "End looplinux-final.sh"
echo "#################################"
rm /usr/local/bin/looplinux-all-cores.sh
rm /usr/local/bin/looplinux-final.sh
