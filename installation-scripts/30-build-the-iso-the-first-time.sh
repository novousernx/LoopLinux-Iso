...
echo
	...
	looplinuxVersion='v21.03.1'

	isoLabel='looplinux-'$looplinuxVersion'-x86_64.iso'

	# setting of the general parameters
	archisoRequiredVersion="archiso 50.1-1"
	buildFolder=$HOME"/looplinux-build"
	outFolder=$HOME"/LoopLinux-Out"
	archisoVersion=$(sudo pacman -Q archiso)
	
	echo "################################################################## "		
	echo "Building the desktop                   : "$desktop
	echo "Building version                       : "$looplinuxVersion
...
echo
	...
	#profiledef.sh
	oldname1='iso_name=looplinux'
	newname1='iso_name=looplinux'

	oldname2='iso_label="looplinux'
	newname2='iso_label="looplinux'
